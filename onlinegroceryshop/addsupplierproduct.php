  ...
  <script type="text/javascript">
      function validate()
      {
          ...
          if(isNaN(r))
          {
           ...
           var rr=document.forms[0].elements[6].value;
          if(rr==null||rr=="")
          {
              document.getElementById("i").innerHTML="<font color=red>Fill Date";
              return false;
          }
          return true;
      }
...
<div class="container">
  ...
  <form action="productsupplieradd.php" onsubmit="return validate()">
...
<div class="form-group">
    ...
    <a href="supplierdashboard.php" class="btn btn-primary">Dashboard</a>
  </form>
</div>
