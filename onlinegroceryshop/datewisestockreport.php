...
<body>
    <h2 class="text-danger" align="center">Product Wise Report</h2>
    <?php
    ...
    echo "<div class=col-lg-2></div><div class=col-lg-4>";
        ...
        echo "<p class=text-warning><font size=5>Choose Product:</font><br><br><select name=txtpname class=form-control align=center>";
...
?>
    ...
    <?php 
        ...
        echo "<tr><th>Product Id<th>Product Name<th>Commodity Type<th>Product Type<th>Quantity<th>Unit<th>Rate";
            $input="'".$_REQUEST['txtpname']."'";
            if(isset($input))
            {
        $rs=mysqli_query($connect,"select * from product where pname=".$input."");
        while($array=mysqli_fetch_array($rs))
        {
            echo "<tr>";
            echo "<td>$array[0]";
