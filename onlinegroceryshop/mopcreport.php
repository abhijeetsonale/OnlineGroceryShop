...
<body>
    <h2 class="text-danger" align="center">  Mode Wise Customer Payment Report</h2>
    <?php
    ...
    echo "<div class=col-lg-2></div><div class=col-lg-4>";
        ...
        $query="select distinct(mop) from invoice";
...
?>
    ...
    <?php 
        ...
        echo "<tr><th>Invoice Id<th>Customer Name<th>Transaction Id<th>Mode of Payment<th>Date of Payment<th>Amount";
            ...
            if(isset($input))
            {
        $rs=mysqli_query($connect,"select * from invoice where mop=".$input."");
        while($array=mysqli_fetch_array($rs))
        {
            echo "<tr>";
            echo "<td>$array[0]";
