...
<body>
	<?php 
		...
		echo "<tr><th>Product Id<th>Product Name<th>Commodity Type<th>Product Type<th>Quantity<th>Unit<th>Rate<th>Addtocart";
		...
		while($array=mysqli_fetch_array($rs))
		{
			...
			echo "<td>$array[5]";
			echo "<td>$array[6]";
			echo "<td><a href=addtocart.php?a=$array[0]>Addtocart</a>";
