...
<body>
	<?php 
		...
		echo "<tr><th>Product Id<th>Product Name<th>Commodity Type<th>Product Type<th>Quantity<th>Unit<th>Rate<th>Edit<th>Delete";
		...
		while($array=mysqli_fetch_array($rs))
		{
			...
			echo "<td>$array[5]";
			echo "<td>$array[6]";
			echo "<td><a href=editproduct.php?a=$array[0]>Edit</a>";
			echo "<td><a href=deleteproduct.php?b=$array[0]>Delete</a>";
