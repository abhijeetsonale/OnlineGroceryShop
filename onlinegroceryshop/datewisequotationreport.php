...
<body>
    <h2 class="text-danger" align="center">Date Wise Quotation Report</h2>
    <?php
    ...
    echo "<div class=col-lg-2></div><div class=col-lg-4>";
        ...
        $query="select distinct(dateofq) from quotation";
...
?>
    ...
    <?php 
        ...
        echo "<tr><th>Quotation Id<th>Product Name<th>Commodity Type<th>Product Type<th>Quantity<th>Unit
            ...
            if(isset($input))
            {
        $rs=mysqli_query($connect,"select * from quotation where dateofq=".$input."");
        while($array=mysqli_fetch_array($rs))
        {
            echo "<tr>";
            echo "<td>$array[0]";
